...
// BuscaPorEmail busca um usuário por email e retorna o seu id e senha com hash
...
// BuscarSEguidores traz todos os usuários que um determinado usuário esta seguindo
